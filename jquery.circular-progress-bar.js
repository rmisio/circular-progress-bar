var circularProgressBar = (function($) {
  ...
  function init(args) {
    ...
    var width = parseInt(args.width, 10) || 20;
    var initialPercentage = parseInt(args.initialPercentage, 10);
    var activeColor = args.activeColor || 'orange';
    var inactiveColor = args.inactiveColor || "#d1d1d1";
    var innerColor = args.innerColor || '#ffffff';
